...
class User(db.Model):
    ...
    given_ratings = db.relationship('Rating', back_populates='rating_user', foreign_keys='[Rating.rating_user_id]')
    received_ratings = db.relationship('Rating', back_populates='rated_user', foreign_keys='[Rating.rating_user_id]')
